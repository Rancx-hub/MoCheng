var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      S.UI.simulate('Hi 源姐|祝你|生日快乐|Happy Birthday|打开声音|准备好了吗|3|2|1|#countdown 3||');
    }
        ...
        case 'countdown':
          ...
          const countdownFn = (countIndex) => {
            if (countIndex === 0) {
              ...
              S.Shape.switchShape(S.ShapeBuilder.letter(countdownValue), true);
              countdownValue--;
            }
          };
          // 直接调用 timedAction 处理倒计时
          timedAction(countdownFn, 1000, value, true);
          break;
